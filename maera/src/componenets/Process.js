...
function Process() {
  ...
  <div className='row mt-5'>
       ...
       <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 process-text-1' >
            <div className='text-align-center'>
            <h2 className='mb-3'>Design Consultation</h2>
    ...
    <div className='container'>
       <div className='row mt-5'>
        ...
        <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 '>
            ...
            <h2 className=' mb-3'>Conceptualization</h2>
...
<section>
  ...
  <div className='row mt-5'>
       ...
       <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12' style={{marginTop:'17rem'}}>
            <div className='text-align-center '>
            <h2 className=' mb-3'>Production</h2>
